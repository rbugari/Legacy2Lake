...
def execute_test():
    print("TEST: AWS-SILVER-01")
    with open("prompt_lab/cartridges/aws/silver_layer.md", 'r', encoding='utf-8') as f:
        prompt = f.read()
    
    response = requests.post(f"{API_BASE}/transpile/task",
        json={"node_data": {"layer": "silver", "tech_id": "aws", "cartridge_prompt": prompt},
    ...
    if response.status_code == 200:
        ...
        with open("prompt_lab/TEST_OUTPUT_AWS_GLUE_SILVER_01.py", 'w', encoding='utf-8') as f:
            f.write(code)
