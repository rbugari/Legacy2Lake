...
# [DISABLED_BY_ARCHITECT]     df_source.limit(0).write.format('delta').saveAsTable(target_table)
...
# [DISABLED_BY_ARCHITECT] logger.info(f"Consider running: OPTIMIZE {target_table} ZORDER BY (custid) and VACUUM {target_table} RETAIN 0 HOURS")
