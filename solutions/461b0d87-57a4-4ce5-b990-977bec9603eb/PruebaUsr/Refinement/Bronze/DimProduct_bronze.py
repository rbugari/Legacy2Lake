...
# [DISABLED_BY_ARCHITECT]         # Post-load tuning hints (comments only) - consider running OPTIMIZE / ZORDER on heavy-read columns
# [DISABLED_BY_ARCHITECT]         # Example: spark.sql(f"OPTIMIZE {TARGET_SCHEMA}.{GOLD_FACT_PREFIX}sales ZORDER BY (product_sk, order_id)")
