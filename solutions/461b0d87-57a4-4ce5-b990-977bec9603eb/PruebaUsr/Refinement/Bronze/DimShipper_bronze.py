...
# [DISABLED_BY_ARCHITECT]                 (empty_df.write.format("delta").mode("overwrite").option("overwriteSchema", "true").saveAsTable(table_full_name))
...
# [DISABLED_BY_ARCHITECT]         # Note: Consider running OPTIMIZE on dimension and fact tables for Z-Ordering on commonly filtered keys
        # For example:
# [DISABLED_BY_ARCHITECT]         # spark.sql("OPTIMIZE {dim_product_tbl} ZORDER BY (productid)")
# [DISABLED_BY_ARCHITECT]         # spark.sql("OPTIMIZE {fact_sales_tbl} ZORDER BY (orderid, productid)")
