...
# [DISABLED_BY_ARCHITECT]             df_source.write.format('delta').mode('overwrite').option('overwriteSchema', 'true').saveAsTable(target_table)
            # OPTIMIZATION HINTS
# [DISABLED_BY_ARCHITECT]             # spark.sql(f"OPTIMIZE {target_table}")
# [DISABLED_BY_ARCHITECT]             # spark.sql(f"VACUUM {target_table} RETAIN 168 HOURS")
        return True
