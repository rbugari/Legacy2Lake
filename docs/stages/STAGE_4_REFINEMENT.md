...
Current v4.4 artifact behavior:

- structured_refinement keeps medallion-oriented outputs (`bronze`, `silver`, `gold`)
- intelligent_reengineering emits separated artifacts under:
	- `reengineered/shared`
	- `reengineered/core`
	- `reengineered/publish`
- compatibility references for legacy `bronze/silver/gold` consumers are preserved
